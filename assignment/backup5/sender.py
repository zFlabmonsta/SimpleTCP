...
class Sender(object):
    ...
    def snd_wind_pckt(self):
        while (self.window < self.num_windows and self.index < len(self.stp_segment.segments) and self.window_ack < self.num_windows):
    ...
    def run_sendfile(self):
        ...
        while (True):
            ...
            if (self.stp_handshake_completed == False):
            ...
            elif (curr > self.stp_timer.timeout_interval and self.tear_down == False):
                ...
                if ((self.rcvd_packet.isACK() or self.was_dropped == True) and self.tear_down == False):
                    ...
                    #print (self.stp_segment.ack_inc[self.index])
