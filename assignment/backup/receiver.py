...
class Receiver(object):
    ...
    def run_receivefile(self):
        while True:
            ...
            if (self.curr_packet.flags[SYN_FLAG] == 1):
            ...
            if (self.curr_packet.flags[ACK_FLAG] == 1 and self.curr_packet.flags[FIN_FLAG] == 0):
            ...
            if (self.curr_packet.flags[FIN_FLAG] == 1):
                msg = "Sending FIN ..."
                # Create FIN 
                stp_fin = STP_Protocol.stp_fin(self.port)
                # Send FIN flag
                self.send_seg(stp_fin, addr, msg)
                # write the file
                self.rcvd_segs.writefile(self.filename)
